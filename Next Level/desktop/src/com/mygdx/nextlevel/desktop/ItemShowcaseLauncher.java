...
import com.mygdx.nextlevel.screens.ItemShowcaseScreen;
import com.mygdx.nextlevel.screens.MainMenuScreen;

public class ItemShowcaseLauncher {
    public static void main (String[] arg) {
        ...
        new LwjglApplication(new ItemGame(), config);
    }
}

class ItemGame extends NextLevel {
    @Override
    public void create () {
        ...
        ItemShowcaseScreen screen = new ItemShowcaseScreen(this);
