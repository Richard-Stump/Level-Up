...
public abstract class BaseTmxMapLoader2<P extends BaseTmxMapLoader2.Parameters> extends AsynchronousAssetLoader<TiledMap, P> {
    ...
    public BaseTmxMapLoader2 (FileHandleResolver resolver) {
        super(resolver);
    }
