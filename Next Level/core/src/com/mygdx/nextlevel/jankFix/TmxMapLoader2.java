 ...
 ******************************************************************************/
package com.mygdx.nextlevel.jankFix;
...
public class TmxMapLoader2 extends BaseTmxMapLoader2<TmxMapLoader2.Parameters> {

    public static class Parameters extends BaseTmxMapLoader2.Parameters {

    }

    public TmxMapLoader2 () {
     ...
     *
     * @param resolver */
    public TmxMapLoader2 (FileHandleResolver resolver) {
        super(resolver);
    }
    ...
    public TiledMap load (String fileName) {
        return load(fileName, new TmxMapLoader2.Parameters());
    }
     ...
     * @return the TiledMap */
    public TiledMap load (String fileName, TmxMapLoader2.Parameters parameter) {
